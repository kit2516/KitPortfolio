...
const socialLinks = [
    { platform: "GitHub", href: "https://github.com/kit2516", iconPath: "/icons/github_icon.svg" }, // <-- Replace YOUR_GITHUB_LINK and icon path
    { platform: "LinkedIn", href: "https://www.linkedin.com/in/kit-benedic-aguing-5ab862341/", iconPath: "/icons/linkedin_icon.svg" }, // <-- Replace YOUR_LINKEDIN_LINK and icon path
    { platform: "Gmail", href: "mailto:kitaguing6@gmail.com", iconPath: "/icons/gmail_icon.svg" }, // <-- Replace YOUR_EMAIL_ADDRESS and icon path
];

// Define contact information
const contactInfo = {
    email: "kitaguing6@gmail.com",
};
