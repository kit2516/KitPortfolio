      ...
      {/* Added responsive hidden class */}
        ...
        <div className="flex flex-col w-full max-w-5xl mx-auto p-4 md:p-4 my-10 md:my-20"> {/* Changed p-15 to p-4 */}
          ...
          <div className="hidden md:block">
            <FallingText
              text={` Aside from being a developer and content creator, I enjoy hiking, camping, mountaineering, and online games like Dota 2 and Mobile Legends. I also join hackathons to solve real problems and connect with people`}
              highlightWords={["Developer", "Dota2", "problems", "camping", "hackathons"]}
              trigger="hover"
